...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lblTitle" runat="server" style="z-index: 1; left: 190px; top: 86px; position: absolute" Text="Stock Login Page"></asp:Label>
        </div>
        ...
        <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" style="z-index: 1; left: 264px; top: 370px; position: absolute" Text="Cancel" />
