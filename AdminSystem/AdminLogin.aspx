...
<head runat="server">
   ...
   /* #banner#{
    ...
    #message{
        text-align:left;
       /* <div id="banner">
 <p>Welcome to Sprint Squad!</p>    //if worked it would be put in between head and body
     <div id="message">
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" style="z-index; top: 161px; position:absolute; left: 355px; bottom: 471px;"  Text="lblError" ForeColor="#FF3300" Visible="False"></asp:Label>
